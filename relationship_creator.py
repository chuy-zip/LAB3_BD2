...
# Ejemplo para crear una relación "WORKS_WITH" entre dos nodos
to_node_data = {
    "labels": "Movie",
    "attributes": {"title": "Hoffa"}
}

from_node_data = {
    "labels": "User",
    "attributes": {"name": "Blum"}
}

currenttiem = datetime.datetime.now()
relationship_properties = {"rating": 10, "timeStamp": currenttiem}

create_relationship(driver, "RATED", relationship_properties, from_node_data, to_node_data)
